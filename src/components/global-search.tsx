...
export function GlobalSearch() {
  ...
  const mockResults: SearchResult[] = [
    { id: '1', type: 'pipeline', title: 'ETL Customer Data', description: 'Daily customer data ingestion pipeline', href: '/pipelines/1' },
    { id: '2', type: 'pipeline', title: 'Product Analytics', description: 'Product metrics aggregation pipeline', href: '/pipelines/2' },
    { id: '3', type: 'dataset', title: 'user_events', description: 'User interaction events table', href: '/freshness' },
    { id: '4', type: 'incident', title: 'Pipeline Failure #1234', description: 'ETL timeout error at 14:30', href: '/incidents' },
    { id: '5', type: 'page', title: 'API Monitoring', description: 'View API performance metrics', href: '/api-monitoring' },
    { id: '6', type: 'page', title: 'Segmentation', description: 'User segmentation analytics', href: '/segmentation' },
  ];
    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-4 top-20 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-[600px] max-h-[80vh] bg-card border border-border rounded-xl shadow-2xl z-50 overflow-hidden">
            {/* Search Input */}
            ...
            <div className="flex items-center justify-between px-4 py-2 border-t border-border bg-muted/50 text-xs text-muted-foreground">
              <div className="flex items-center gap-4">
                <span>
                  <kbd className="px-1.5 py-0.5 bg-background rounded border">↑↓</kbd> to navigate
                </span>
                <span>
                  <kbd className="px-1.5 py-0.5 bg-background rounded border">↵</kbd> to select
                </span>
              </div>
              <span>
                <kbd className="px-1.5 py-0.5 bg-background rounded border">esc</kbd> to close
              </span>
            </div>
          </div>
        </>

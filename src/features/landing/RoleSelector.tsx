  ...
  const roles: Role[] = [
    {
      ...
      description: 'Build and maintain robust data pipelines with real-time monitoring and alerting.',
      features: ['Pipeline Orchestration', 'ETL Monitoring', 'Error Tracking', 'Performance Optimization'],
    ...
    },
    {
      ...
      description: 'Explore datasets, track freshness metrics, and ensure data quality across the organization.',
      features: ['Data Freshness', 'Quality Metrics', 'SLA Monitoring', 'Insights Dashboard'],
    ...
    <div className="w-full max-w-4xl mx-auto">
          ...
          >
            ...
            <div
              className={`absolute inset-0 bg-gradient-to-br ${
                hoveredRole === role.id ? role.hoverGradient : role.gradient
            ...
            {/* Decorative Corner */}
            <div
              className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-primary/10 to-transparent rounded-bl-full transition-opacity duration-300 ${
      ...
      <div className="mt-8 text-center">
        <Button
          variant="ghost"
          onClick={() => {
            toast.success('Welcome to DataOps Analytics!', { duration: 2000 });
            localStorage.setItem('hasExploredApp', 'true');

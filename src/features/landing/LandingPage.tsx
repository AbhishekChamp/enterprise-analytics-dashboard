...
import { BarChart3, Shield, Activity, Zap, TrendingUp, Lock, Globe } from 'lucide-react';
...
export const LandingPage = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Deep insights into pipeline performance with historical trends and forecasting',
    ...
    },
    {
      ...
      description: 'Deploy and monitor pipelines across multiple cloud regions and providers',
      ...
      <div className="flex flex-col">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Comprehensive monitoring and analytics tools designed for modern data teams
              </p>
            </div>
        ...
        <section className="py-16 sm:py-20 bg-background">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="rounded-2xl bg-gradient-to-br from-primary/10 via-primary/5 to-background border border-primary/20 p-8 sm:p-12">
              <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">
                Ready to explore?
              </h2>
              <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                Dive into the dashboard and experience a modern approach to data pipeline monitoring.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <div className="text-sm text-muted-foreground">
                  No credentials required • Free to explore • Instant access
                </div>
              </div>
            </div>
          </div>
